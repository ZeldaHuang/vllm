...
def test_get_new_notifs_cancel_unleased_is_ignored(caplog, monkeypatch):
    ...
    # caplog captures via the root logger; vllm loggers don't propagate.
    monkeypatch.setattr(pull_worker.logger, "propagate", True)
    w = _pull_worker_stub()
